...
import "github.com/hanzo-ds/go/lib/col"
...
type (
	...
	JSONSerializer = col.JSONSerializer
...
func NewDynamicWithType(v any, chType string) Dynamic {
	return col.NewDynamicWithType(v, chType)
}
...
func ExtractJSONPathAs[T any](o *JSON, path string) (valueAs T, ok bool) {
	return col.ExtractJSONPathAs[T](o, path)
}
...
func ExtractJSONPathAsDynamic(o *JSON, path string) (Dynamic, bool) {
	return col.ExtractJSONPathAsDynamic(o, path)
}
